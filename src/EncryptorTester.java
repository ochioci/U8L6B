...
public class EncryptorTester
{
  public static void main(String[] args)
  {
    ...
    // --------------------------------
    Encryptor encryptor1 = new Encryptor (3,3);
    String msg = (encryptor1.decryptMessage("I love ice cream so much!"));
    Encryptor encryptor2 = new Encryptor(4,4);
    System.out.println(encryptor2.decryptMessage(msg));
